...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section id="about" className="py-24 relative bg-[#020205] border-t border-white/5 overflow-hidden">
      {/* Background glow matching Immersive UI */}
      <div className="absolute top-1/2 left-[-10%] w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-0 right-[-10%] w-[500px] h-[500px] bg-purple-600/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-10">
          <div className="flex p-1 bg-white/5 border border-white/10 rounded-xl backdrop-blur-md overflow-x-auto max-w-full">
            <button
        ...
        {/* Tab Content Display */}
        <div className="bg-[#0A0A10]/70 border border-white/10 rounded-2xl p-6 sm:p-10 backdrop-blur-xl shadow-2xl relative overflow-hidden">
              ...
              <div className="md:col-span-7 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                  <div className="p-3.5 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                    <div className="text-xs font-mono text-blue-400">Community Lead</div>
                    <div className="text-sm font-semibold text-white mt-0.5">iGen Official Member</div>
                    <p className="text-[11px] text-slate-400 mt-1">Directing emerging tech forums and student innovation pods.</p>
                  </div>
                  <div className="p-3.5 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                    <div className="text-xs font-mono text-purple-400">Anthropic Verified</div>
                    <div className="text-sm font-semibold text-white mt-0.5">4x Certified Specialist</div>
                    <p className="text-[11px] text-slate-400 mt-1">Platform, Code, Cowork, and Constitutional AI.</p>
                  </div>
                </div>
              </div>

              <div className="md:col-span-5 flex flex-col gap-3">
                <div className="p-5 rounded-xl bg-gradient-to-br from-blue-950/40 to-slate-900 border border-blue-500/20">
                  <div className="flex items-center gap-3 mb-2">
                    <Terminal className="w-5 h-5 text-blue-400" />
                    <span className="text-xs font-mono text-blue-300 uppercase tracking-wider">Engineering Principles</span>
                  </div>
                ...
                <div className="p-5 rounded-xl bg-slate-950/60 border border-white/[0.06]">
                  <div className="text-xs font-mono text-slate-400 mb-1">Direct Contact Vector</div>
                  <div className="text-sm font-semibold text-white font-mono">{PERSONAL_INFO.email}</div>
                  <div className="text-xs text-slate-400 font-mono mt-0.5">{PERSONAL_INFO.phone}</div>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                <div className="p-4 rounded-xl bg-slate-900/60 border border-white/[0.06]">
                  <div className="text-xs font-mono text-blue-400 mb-1">Algorithmic Foundations</div>
                  <p className="text-xs text-slate-300 leading-relaxed">
                    Data structures, object-oriented design in Java/C++, time complexity proofs, and discrete systems.
                  </p>
                </div>
                <div className="p-4 rounded-xl bg-slate-900/60 border border-white/[0.06]">
                  <div className="text-xs font-mono text-purple-400 mb-1">AI & Machine Learning</div>
                  <p className="text-xs text-slate-300 leading-relaxed">
                    Mathematical probability, vector linear algebra, deep neural architectures, and transformer attention.
                  </p>
                </div>
                <div className="p-4 rounded-xl bg-slate-900/60 border border-white/[0.06]">
                  <div className="text-xs font-mono text-emerald-400 mb-1">Software Systems</div>
                  <p className="text-xs text-slate-300 leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-5 rounded-xl bg-slate-900/60 border border-white/[0.06]">
                  <div className="flex items-center gap-2.5 text-blue-400 mb-2">
                    ...
                    <span className="font-semibold text-sm text-white">Civic & Road Safety (RoadGuard AI)</span>
                  </div>
                ...
                <div className="p-5 rounded-xl bg-slate-900/60 border border-white/[0.06]">
                  <div className="flex items-center gap-2.5 text-purple-400 mb-2">
                    ...
                    <span className="font-semibold text-sm text-white">Education Accessibility (AI Productivity)</span>
                  </div>
                  <p className="text-xs text-slate-400 leading-relaxed">
          ...
          {activeTab === 'roadmap' && (
            <div className="space-y-4">
              <div className="text-xs font-mono text-slate-400 mb-2">Long-term Strategic Vision (2024 - 2029)</div>
              <div className="relative border-l-2 border-blue-500/30 pl-6 space-y-6 ml-2">
                <div className="relative">
                  <div className="absolute -left-[31px] top-1 w-3.5 h-3.5 rounded-full bg-blue-500 ring-4 ring-blue-500/20" />
                  <div className="text-xs font-mono text-blue-400">Current • 2024 - 2025</div>
                  <h4 className="text-sm font-semibold text-white mt-0.5">Undergraduate AI Research & Anthropic Certification</h4>
                  <p className="text-xs text-slate-400 mt-1">
                ...
                <div className="relative">
                  <div className="absolute -left-[31px] top-1 w-3.5 h-3.5 rounded-full bg-slate-700 ring-4 ring-slate-800" />
                  <div className="text-xs font-mono text-purple-400">Upcoming • 2026 - 2027</div>
                  <h4 className="text-sm font-semibold text-white mt-0.5">Scalable Agentic Software Engineering & Hackathon Leadership</h4>
                  <p className="text-xs text-slate-400 mt-1">
                ...
                <div className="relative">
                  <div className="absolute -left-[31px] top-1 w-3.5 h-3.5 rounded-full bg-slate-700 ring-4 ring-slate-800" />
                  <div className="text-xs font-mono text-emerald-400">Target • 2028 - 2029</div>
                  <h4 className="text-sm font-semibold text-white mt-0.5">Founding AI-First Innovations & Applied Research Lab</h4>
                  <p className="text-xs text-slate-400 mt-1">
